  ...
  const getProcessSteps = (vehicleType: string) => {
    const steps: { [key: string]: (string | { id: number; nameKo: string; nameEn: string } | { time: string; routeKo: string; routeEn: string } | { clock: string; routeKo: string; routeEn: string })[] } = {
      ...
      busSeoulTwo: [
        ...
        {id: 105900002, nameKo: "", nameEn: "Kyunghee University Station"},
        {id: 100000025, nameKo: "의료원입구사거리", nameEn: "Medical Institution Entrance Crossing"},
        {id: 105900001, nameKo: "경희대", nameEn: "Kyunghee University"},
        {id: 105900004, nameKo: "경희대입구", nameEn: "Kyunghee University Station"},
        {id: 105900003, nameKo: "회기역", nameEn: "Hoegei Station"},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "외대앞역", nameEn: "Foreign Language University Front Station"},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "외대/경희대후문", nameEn: "Foreign Language University/Kyunghee University Back Gate"},
        {id: 105900003, nameKo: "경희대동문", nameEn: "Kyunghee University East Gate"},
        {id: 105900003, nameKo: "경희맨션", nameEn: "Kyunghee Apartment"},
        {id: 105900003, nameKo: "경희중고", nameEn: "Kyunghee Middle/High School"},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "", nameEn: ""},
        {id: 105900003, nameKo: "회기역", nameEn: "Hoegei Station"}
      ],
